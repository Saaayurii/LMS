...
const SearchPage = () => {
  ...
  const {0:selectedCategories, 1:setSelectedCatgories} = useState([]);
  const {0:sortByPrice, 1:setSortByPrice} = useState("");
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8">
      <div className="my-6">
        <h1 className="font-bold text-xl md:text-2xl">Результат: "{query}"</h1>
        <p>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-32 dark:bg-gray-900 p-6">
      ...
      <p className="text-lg text-gray-600 dark:text-gray-400 mb-4">
        Извините, мы не могли найти курс, который вы ищете.
      </p>
      <Link to="/" className="italic">
        <Button variant="link">Просмотрите все курсы</Button>
      </Link>
    </div>
  );
};
